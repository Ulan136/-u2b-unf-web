...
// Локальная дата в формате YYYY-MM-DD (без сдвига в UTC, как у toISOString).
function ymd(d: Date) {
  ...
  return (
    <div className="min-h-screen">
      <header className="bg-yellow-400 text-gray-900 px-6 py-3 shadow flex items-center gap-4">
        ...
        <h1 className="text-lg font-semibold">Отчёт: Продажи</h1>
      </header>
      ...
      <main className="max-w-6xl mx-auto p-4">
        ...
        <p className="text-xs text-gray-400 mt-2">
          В отчёт попадают только отгруженные заказы (по дате отгрузки).
        </p>
      </main>
    </div>
  );
